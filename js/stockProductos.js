let productos=[]
class producto {
    constructor(id, descripcionProducto, precioVentaUnitario, stockProducto,img) {
      this.id = id;
  ...
  function traerProductosDeLaBase(){
    ...
    let producto6 = new producto(6, "Heraclito clasico 700mlproducto6", 4500, 180,"../img/heraclitolondondry.png" );
    let producto7 = new producto(7, "Whisky Jack Daniels 750ml", 12000, 170, "../img/whiskyjackdaniels.png");
    let producto8 = new producto(8, "Ron Avana Club clasico 700mlproducto8", 6300, 165, "../img/ronavanaclub.png");
